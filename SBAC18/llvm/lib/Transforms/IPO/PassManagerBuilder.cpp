...
#include "llvm/Transforms/OMPUseDependenceAnalysis.h"
#include "llvm/Transforms/OMPCheckPass.h"

using namespace llvm;

static cl::opt<bool>
RunOMPUseDependenceAnalysis("omp-use-dependence-analysis", cl::Hidden,
                     cl::desc("Run OpenMP use clause dependence analysis"));
// OMPCheckPass -- check clause
static cl::opt<bool>
RunOMPCheckInstrumentation("omp-check-instrumentation", cl::Hidden,
                     cl::desc("Run OMP Check instrumentation pass"));
...
PassManagerBuilder::PassManagerBuilder() {
    ...
    // OMP use clause
    OMPUseDependenceAnalysisEnabled = RunOMPUseDependenceAnalysis;
    // OMPCheckPass -- check clause
    OMPCheckInstrumentation = RunOMPCheckInstrumentation;
}
...
void PassManagerBuilder::populateFunctionPassManager(
  ...
  if (OMPUseDependenceAnalysisEnabled) {
    FPM.add(createOMPUseDependenceAnalysisPass());
  }
...
void PassManagerBuilder::populateModulePassManager(
  ...
  // OMPCheckPass -- check clause
  if (OMPCheckInstrumentation) {
    MPM.add(createOMPCheckPass());
  }
