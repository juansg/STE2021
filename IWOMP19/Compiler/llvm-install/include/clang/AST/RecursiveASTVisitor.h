...
// Luis Felipe - Template for Use clause visitor
template <typename Derived>
bool RecursiveASTVisitor<Derived>::VisitOMPUseClause(OMPUseClause *) {
  return true;
}

// OMP check clause
template <typename Derived>
bool RecursiveASTVisitor<Derived>::VisitOMPCheckClause(OMPCheckClause *) {
  return true;
}
