...
// Disable the verification pass in -asserts builds.
  ...
  if (Args.hasFlag(options::OPT_fomp_use_dependence_analysis,
        options::OPT_fno_omp_use_dependence_analysis, false)) {
    CmdArgs.push_back("-omp-use-dependence-analysis");
  }
