...
uchar c,*p,*cp;
  ...
  gettimeofday(&start_time, NULL);
   ...
   #pragma omp parallel for ordered(1) default(none) schedule(auto) firstprivate(mid,r,max_no,bp,x_size,in,y_size) private(j,w,y,x,b,a,m,do_symmetry,z,n,c,cp,p) num_threads(4)  //spec(n)
