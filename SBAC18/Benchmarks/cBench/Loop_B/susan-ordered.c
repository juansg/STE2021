...
//	#pragma omp parallel for ordered(1) num_threads(2) private(n, p, cp, x, y, c, xx, yy, sq, divide, j) 
  for (i=5;i<y_size-5;i++) {
	gettimeofday(&start_time, NULL);
	#pragma omp parallel for ordered(1) private(n, p, cp, x, y, c, xx, yy, sq, divide)
