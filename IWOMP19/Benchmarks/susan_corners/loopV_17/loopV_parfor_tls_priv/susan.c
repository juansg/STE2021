                   ...
                   int x_size, int y_size)
{
    ...
    #pragma omp parallel for schedule (static,1) default(none) shared(next_iter_commit,n) firstprivate(x_size,y_size,r,corner_list,cgx,cgy,in) private(j,x,i) num_threads(4)  //spec(n)
