...
static bool ParseCodeGenArgs(CodeGenOptions &Opts, ArgList &Args, InputKind IK,
  ...
  // OpenMP use clause
  Opts.OMPUseDependenceAnalysisEnabled = Args.hasArg(OPT_omp_use_dependence_analysis);
  // OMPCheckPass -- check clause
  Opts.OMPCheckInstrumentation = Args.hasArg(OPT_omp_check_instrumentation);
