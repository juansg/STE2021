                 ...
                 int max_no, int x_size, int y_size)
{
    ...
    #pragma omp parallel for schedule (static,1) default(none) shared(next_iter_commit) firstprivate(mid,r,max_no,bp,x_size,in,y_size) private(cont,i,j,w,y,x,b,a,m,do_symmetry,z,n,c,cp,p,mid_arr) num_threads(4)
