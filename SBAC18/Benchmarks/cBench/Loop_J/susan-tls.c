...
/* }}} */
  ...
  #pragma omp parallel for ordered(1) use(tls,1) firstprivate(dp,in,mask_size,x_size,bp,increment,in_aux) private(area,total,dpt,j,tmp,brightness,x,y,cp,centre,ip,out) num_threads(4) // linear(out:)  
