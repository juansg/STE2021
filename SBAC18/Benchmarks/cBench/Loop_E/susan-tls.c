...
/* }}} */
  ...
  #pragma omp parallel for ordered(1) use(tls,15) firstprivate(dp,in,mask_size,x_size,bp,increment,i,out_aux) private(area,total,dpt,j,tmp,brightness,x,y,cp,centre,ip) lastprivate(out) num_threads(4) // linear(out:)  
