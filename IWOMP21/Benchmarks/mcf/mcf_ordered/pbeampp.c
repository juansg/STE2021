...
NEXT:
    ...
    #pragma omp parallel for ordered(1) schedule(auto) default(none) shared(basket_size) firstprivate(stop_arcs,arc2,iterations,perm,nr_group) private(red_cost,cond1,cond2,arc,basket_sizeL) num_threads(4)
