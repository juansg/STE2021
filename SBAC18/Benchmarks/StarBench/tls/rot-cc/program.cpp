...
void __attribute__((noreturn)) _xabort2(char n __attribute__((unused))) {
	_xabort(0xff);
}
...
bool parseArgs(char* args[], int argc, unsigned int &angle, string &inname, string &outname);
