...
void EmitAssemblyHelper::CreatePasses(legacy::PassManager &MPM,
  ...
  // OpenMP use clause
  PMBuilder.OMPUseDependenceAnalysisEnabled = CodeGenOpts.OMPUseDependenceAnalysisEnabled;
  // OMPCheckPass -- check clause
  PMBuilder.OMPCheckInstrumentation = CodeGenOpts.OMPCheckInstrumentation;
