...
uchar c,*p,*cp;
  ...
  #pragma omp parallel for ordered(1) default(none) schedule(auto) firstprivate(x_size,y_size,r,corner_list,cgx,cgy,in) shared(n) private(j,x) num_threads(4)  //spec(n)
  for (i=5;i<y_size-5;i++){
