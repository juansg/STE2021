...
uchar c,*p,*cp;
  ...
  #pragma omp parallel for schedule (static,1) default(none) shared(next_iter_commit) firstprivate(in,x_size,bp,max_no,r,y_size) private(j,p,cp,n,i,cont) num_threads(4)  
