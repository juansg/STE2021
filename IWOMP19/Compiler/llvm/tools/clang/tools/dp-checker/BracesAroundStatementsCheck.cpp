...
void BracesAroundStatementsCheck::registerMatchers(MatchFinder *Finder) {
  Finder->addMatcher(findAll(ifStmt().bind("if")), this);
  Finder->addMatcher(findAll(whileStmt().bind("while")), this);
  Finder->addMatcher(findAll(doStmt().bind("do")), this);
  Finder->addMatcher(findAll(forStmt().bind("for")), this);
  Finder->addMatcher(findAll(cxxForRangeStmt().bind("for-range")), this);
}

//void BracesAroundStatementsCheck::check(
void BracesAroundStatementsCheck::run(
...
bool BracesAroundStatementsCheck::checkStmt(
  ...
  TheRewriter.InsertTextBefore(EndLoc, ClosingInsertion);
